...
public class SC8 {
    ...
    //FOR
    public static void SerieCacacterFor(Scanner scanner){
    ...
    //WHILE
    public static void SerieCacacterWhile(Scanner scanner){
    ...
    //DO WHILE
    public static void SerieCaracterDoWhile(Scanner scanner){
